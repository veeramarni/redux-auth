	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        _semanticUiReact.Modal,
	        {
	          ...
	          closeIcon: "close" },
	        _react2.default.createElement(_semanticUiReact.Modal.Header, { content: this.props.title }),
	        _react2.default.createElement(
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        _semanticUiReact.Modal,
	        {
	          ...
	          closeIcon: "close" },
	        _react2.default.createElement(_semanticUiReact.Modal.Header, { content: "Reset Your Password" }),
	        _react2.default.createElement(
	          "form",
	          { className: "ui form" },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_ButtonLoader2.default, _extends({}, this.props, {
	              ...
	              icon: _react2.default.createElement(_semanticUiReact.Icon, { name: "lock" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	SignOutButton.defaultProps = {
	  ...
	  icon: _react2.default.createElement(_semanticUiReact.Icon, { name: "sign out" })
	};
	exports.default = (0, _reactRedux.connect)(function (_ref) {
	  var auth = _ref.auth;
	  return { auth: auth };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _extends({
	            loading: loading,
	            type: "submit",
	            icon: _react2.default.createElement(_semanticUiReact.Icon, { name: "send" }),
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _extends({ loading: loading,
	            ...
	            icon: this.props.icon || _react2.default.createElement(_semanticUiReact.Icon, { name: "lock" }),
	            onClick: this.handleSubmit.bind(this)
	          }, this.props.inputProps.submit),
	          "Update Password"
	        )
